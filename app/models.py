...
class LegalCase(Base):
    ...
    intake_status: Mapped[str] = mapped_column(String(32), default="APPROVED")
    intake_admin_comment: Mapped[str] = mapped_column(Text, default="")
    is_consultation: Mapped[bool] = mapped_column(Boolean, default=False)
    allow_phone_contact: Mapped[bool] = mapped_column(Boolean, default=False)
    preferred_contact_method: Mapped[str] = mapped_column(String(24), default="CHAT")
